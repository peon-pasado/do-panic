...
Given a pile with $N$ snacks, there are two players that take turns alternately. In one turn, the active player can eat between $1$ and $\min{\lbrace N, M\rbrace}$  from the pile. Then:
